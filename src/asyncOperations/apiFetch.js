...
async function fetchMoviesList(category, page) {
    const categoryApi = `https://api.themoviedb.org/3/discover/movie?api_key=ace7b669ec91ad7702878aa98fd99d60&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_genres=${category}&with_watch_monetization_types=flatrate`
    const popularApi = `https://api.themoviedb.org/3/movie/popular?api_key=ace7b669ec91ad7702878aa98fd99d60&language=en-US&page=${page}`
